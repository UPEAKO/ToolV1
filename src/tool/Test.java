...
import tool.Level.LevelApproximation;
...
public class Test {
    public static void main(String [] args) {
        ...
        System.out.println(Tool.coordinateToAzimuthAngle(3,3,2,4));
        */

        //水准近似平差测试
        LevelApproximation levelApproximation = new LevelApproximation();
        levelApproximation.Calculation();
    }
}
